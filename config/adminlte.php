...
return [
    ...
    */
    ...
    'use_route_url' => false,
    'dashboard_url' => 'dashboard', // Cambiado a 'dashboard' para hacer match con Jetstream
    'logout_url' => 'logout',
    'login_url' => 'login',
    ...
    */
    ...
    'menu' => [
        // Navbar widgets principales
        [
            'type' => 'fullscreen-widget',
            'topnav_right' => true,
        ],

        // Buscador interno del menú lateral
        [
            'type' => 'sidebar-menu-search',
            'text' => 'Buscar...',
        ],

        // Encabezado del menú personalizado para el proyecto RSU

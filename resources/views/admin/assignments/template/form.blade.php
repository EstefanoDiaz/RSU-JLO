...
{!! Form::open(['route' => 'admin.assignment.store', 'method' => 'POST', 'id' => 'formNuevaAsignacion']) !!}
...
$(document).ready(function() {
    ...
    $('#btnValidarDisp').on('click', function() {
        ...
        $.ajax({
            url: "{{ route('admin.assignment.validate') }}",
            type: 'POST',
            data: {
                _token:       '{{ csrf_token() }}',
                start_date:   start,
    ...
    $('#formNuevaAsignacion').on('submit', function(e) {
        ...
        $.ajax({
            ...
            success: function(res) {
                ...
                if (typeof tableAssignment !== 'undefined') tableAssignment.ajax.reload(null, false);

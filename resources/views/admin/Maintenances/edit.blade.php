{!! Form::model($maintenance, ['route' => ['admin.maintenance.update', $maintenance->id], 'method' => 'PUT', 'id' => 'formMaintenanceUpdate']) !!}
    ...
    <div class="modal-footer p-0 pt-3 border-top-0 d-flex justify-content-end">
        ...
        <button type="submit" class="btn btn-sm text-white" style="background-color: #071D38;"><i class="fas fa-sync"></i> Actualizar</button>
    </div>
{!! Form::close() !!}